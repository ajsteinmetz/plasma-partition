...
\begin{multline}
 ...
 \frac{(-1)^{k+1}}{k}\exp\left({k\frac{\sigma\mu+s\eta-{\tilde m}_{s}\varepsilon^{s}_{n}}{T}}\right)\,,
\end{multline}
\begin{align}
 \label{bapprox} 
...
\begin{multline}
 ...
 +\frac{g}{4}\frac{e^{2}}{\pi^{2}}\frac{\eta}{T}\left(\frac{1}{3}\frac{\eta^{2}}{m_{e}^{2}}+\ln\left(\frac{m_{e}}{2T}\right)+\gamma_{\rm E}-\frac{1}{2}\right)\\
 +{\cal O}\left(\frac{m_{e}}{T}\right)^{3}\,,
\end{multline}
where $\gamma_{\rm E}$ is Euler's constant.
