...
% ANDREW: Change this above back to move to two-column style.
...
\begin{align}
\langle \mathcal M\rangle\equiv\frac{1}{V}\langle \mu\rangle=\frac{1}{V}\left(T\frac{\partial \ln\mathcal Z}{\partial B}\right),\qquad \langle\mu\rangle=\left(T\frac{\partial \ln\mathcal Z}{\partial B}\right)
\end{align}
...
\begin{align}
{\langle\Delta \mathcal M^2\rangle}=\frac{\langle\Delta \mu^2\rangle}{V}=\frac{T^2}{V}\frac{\partial^2 \ln\mathcal Z }{\partial B^2}=T\frac{\partial}{\partial B}\left(\frac{T}{V}\frac{\partial \ln\mathcal Z}{\partial B}\right)=T\frac{\partial\langle M\rangle}{\partial B}.
\end{align}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{The fluctuation of magnetized $e^\pm$ plasma }
...
\frac{\partial {\mathfrak M}_{-} }{\partial b_0}&\approx\frac{e^{2}}{\pi^{2}}\frac{T^{2}}{m_{e}^{2}}\xi^{-1}\cosh{\frac{\mu}{T}}\left[\left(\frac{1}{6}\right)K_0(x_{-})\right]\approx \frac{\partial {\mathfrak M}_{+} }{\partial b_0}, \qquad \mathrm{for} \,\,10^{-11}<b_0<10^{-3},
 ...
 \begin{align}
  \langle\Delta \mathcal{M}^2\rangle=\frac{m_e^2}{T}\left(\frac{\partial {\mathfrak M}_{+} }{\partial b_0}+\frac{\partial {\mathfrak M} _{-}}{\partial b_0}\right)\approx \frac{T}{6}\left(\frac{e^{2}}{\pi^{2}}\right)\cosh{\frac{\mu}{T}}\bigg[\xi K_0(x_+)+\xi^{-1}K_0(x_{-})\bigg]
 \end{align} 
 In Fig.~\ref{Flu_fig} we plot the fluctuation $ \langle\Delta {\mathcal M}^2\rangle/m_e$ nd  $\langle\Delta {\mathcal M}^2\rangle/\sqrt{\langle \mathcal M\rangle}$ as a function of temperature with $g=2$,  $\xi=1$, $b_0=10^{-11}$ and $b_0=10^{-3}$.

 
 %~~~Figure~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 \begin{figure}[ht]
 \centering
 \includegraphics[width=0.5\textwidth]{plots/Susceptibility001}\includegraphics[width=0.5\textwidth]{plots/Susceptibility002}
...
\end{figure}
 ...
 \begin{figure}[ht]
 \centering
 \includegraphics[width=0.5\textwidth]{plots/Fluctuation_Magnetization}\includegraphics[width=0.5\textwidth]{plots/Fluctuation_M002}
