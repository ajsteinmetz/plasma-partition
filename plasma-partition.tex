...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\textwidth]{ChemicalPotential_03.jpg}
...
The measured anisotropies in the CMB~\cite{aghanim2018planck} also indicate that the early universe was home to domains of slightly higher and lower baryon densities~\cite{grayson2023electronpositron} making the proton density spatially dependant $n_{p}\rightarrow n_{p}(x)$ which would directly affect the potentials $\mu(x)$ and $\eta(x)$ and thus density of electrons and positrons locally. This would lead to regions of the primordial plasma with higher or lower magnetization and nonzero local angular momentum within those domains providing a natural mechanism for the small but nonzero angular momentum matter clumps must have possessed to form the spinning galaxies of today. Recent measurements by the James Webb Space Telescope (JWST)~\cite{yan2022first,adams2023discovery,arrabal2023spectroscopic} indicate that galaxy formation began surprisingly early at large redshift values of $z\gtrsim10$ within the first 500 million years of the universe. Additionally the observation of supermassive black holes being already present~\cite{larson2023ceers} in this period with masses of millions of Suns indicates the need for exceptionally high density local regions in the early universe.
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\textwidth]{NewMagnetizationDensity003_Boltz.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{SpinPolarizationEffect_01.jpg}
    \caption{The magnetization ${\cal M}$ for various values of $\eta$ (dashed black) with zero external field are compared to the magnetization with external fields (blue and red) and $\eta=0$.}
    \label{fig:ferro} 
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
