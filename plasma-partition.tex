...
\begin{figure}[ht]
    ...
    \caption{The magnetization ${\cal M}{\rm\ [G]}$, with $g=2$, of the primordial $e^{+}e^{-}$ plasma is plotted as a function of temperature. The lower (solid red) and upper (solid blue) bounds for cosmic magnetic scale $b_{0}$ are included. The external magnetic displacement ${\cal H}$ is also plotted in for lower (dashed red) and upper (dashed blue) bounds. The spin fugacity is set to unity $\xi=1$. {\xred Andrew - Have this plot replaced with non-zero chemical potential.}}
    \label{magplot} 
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{align}
    \label{g2magplus}
    \frac{{\cal M}_{+}}{{\cal H}_{C}}&=\frac{q^{2}}{2\pi^{2}}\frac{T^{2}}{m_{e}^{2}}\xi\cosh{\frac{\mu}{T}}\left[\frac{1}{2}x_{+}K_{1}(x_{+})+\frac{b_{0}}{6}K_{0}(x_{+})\right]\,,\qquad x_{+}=\left(\frac{m_{e}}{T}\right)\,,\\
    \label{g2magminus}
    -\frac{{\cal M}_{-}}{{\cal H}_{C}}&=\frac{q^{2}}{2\pi^{2}}\frac{T^{2}}{m_{e}^{2}}\xi^{-1}\cosh{\frac{\mu}{T}}\left[\left(\frac{1}{2}+\frac{b_{0}^{2}}{12x_{-}^{2}}\right)x_{-}K_{1}(x_{-})+\frac{b_{0}}{3}K_{0}(x_{-})\right]\,,\qquad x_{-}=\sqrt{\frac{m_{e}^{2}}{T^{2}}+2b_{0}}\,.
\end{align}
...
\begin{align}
    \lim_{b_{0}\rightarrow0}\frac{\cal M}{{\cal H}_{C}}=\frac{q^{2}}{2\pi^{2}}\sinh{\frac{\eta}{T}}\cosh{\frac{\mu}{T}}\left(\frac{T}{m_{e}}\right)K_{1}\left(\frac{m_{e}}{T}\right)\,.
\end{align}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{magfixedplot.pdf}
    \caption{The magnetization ${\cal M}{\rm\ [G]}$ is plotted (solid red) where the external magnetic displacement (dashed red) is fixed by a value set by the comoving temperature at $T_{0}=10\keV$. The blue curves are defined in \rf{magplot}.}
    \label{magfixedlot} 
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
