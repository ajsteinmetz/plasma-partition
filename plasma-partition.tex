...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{ChemicalPotential_02.jpg}
    \caption{The chemical potential over temperature $\mu/T$ is plotted as a function of temperature with differing values of spin potential $\eta$.}
    \label{fig:chemicalpotential}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

In \rf{fig:chemicalpotential} we plot the chemical potential $\mu/T$ (black line) which characterizes the importance of the charged lepton asymmetry as a function of temperature. Since the baryon (and thus charged lepton) asymmetry remains fixed, the suppression of $\mu/T$ at high temperatures indicates a large pair density. Only the $b_{0}=0$ case was plotted as the para-diamagnetic contribution from \req{paradia} did not appreciably influence $\mu/T$ in the regime considered. Various chemical potential curves are also plotted for differing amounts of spin polarization asymmetry determined by $\eta$.
