...
\label{WReplacement}\sum^{\infty}_{n=0}W^\pm_1(n,k)&=\left(\frac{T^2}{k^2eB}\right)x_{\pm}^{2}K_{2}(x_{\pm})+\frac{1}{2}x_{\pm}K_{1}(x_{\pm})+\frac{1}{12}\left(\frac{k^2eB}{T^2}\right)K_{0}(x_{\pm})+R\,,\qquad x_{\pm} = \frac{k\tilde{m}_{\pm}}{T}\,.
\end{align}
