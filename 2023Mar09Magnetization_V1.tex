...
\end{align}
where $\eta$ is the chemical potential of electron, and energy $E_{n}^\pm$ can be written as
\begin{align}
...
\begin{align}
\ln\mathcal{Z}_{tot}
&=\frac{2eBV}{(2\pi)^2}\sum_{n=0}^\infty\sum^{\infty}_{k=1}\frac{(-1)^{k+1}}{k}\bigg[2\cosh{(k\beta\eta)}\bigg]\int_0^\infty dp_z\,e^{-k\beta E_n^\pm}\notag\\
&=\frac{2eBTV}{(2\pi)^2}\sum^{\infty}_{k=1}\frac{(-1)^{k+1}}{k^2}\bigg[2\cosh{(k\beta\eta)}\bigg]\sum_{n=0}^\infty W^\pm_1(n),
\end{align}
...
&\qquad\qquad\qquad+\frac{1}{12}\left[\left(\frac{k^2eB}{T^2}\right)K_0(k\tilde m_\pm/T)\right]+R.
\end{align}
...
where we defined 
\begin{align}
&\ln\mathcal{Z}_{free}=\frac{2T^3V}{(2\pi)^2}\sum^{\infty}_{k=1}\frac{(-1)^{k+1}}{k^4}\cosh{(k\eta/T)}\left[\left(\frac{k\tilde{m}_\pm}{T}\right)^2K_2(k\tilde m_\pm/T)\right]\\
&\ln\mathcal{Z}_B=\frac{4eBTV}{(2\pi)^2}\sum^{\infty}_{k=1}\frac{(-1)^{k+1}}{k^2}\cosh{(k\eta/T)}\bigg[\frac{k\tilde{m}_\pm}{2T}K_1(k\tilde m_\pm/T)+\frac{k^2eB}{12T^2}K_0(k\tilde m_\pm/T)\bigg]\\
&\ln\mathcal{Z}_R=\frac{4eBTV}{(2\pi)^2}\sum^{\infty}_{k=1}\frac{(-1)^{k+1}}{k^2}\cosh{(k\eta/T)}R
\end{align}
...
In Fig {\ref{Case1_fig}}, we plot the chemical potential $\eta/T$(left) and magnetization $M/B$(right) as a function of temperature $T$. It shows for the case1 the chemical potential and magnetization are not sensitive to the magnetic field, this is because the small value of $b_0=10^{-3}\sim10^{-8}$ and can be neglected in Eq.(\ref{chemical_001}) and Eq.(\ref{Magnetization_001}).
 %~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\begin{figure}[h]
%\begin{center}
\centering
...
\caption{The chemical potential $\eta/T$ (upper) and magnetization $M/B$ (lower) as a function of temperature $20<T<60$keV  for the case 1. The chemical potential and magnetization are not sensitive to the magnetic field, because the small value of $b_0=10^{-3}\sim10^{-8}$ can be neglected in Eq.(\ref{chemical_001}) and Eq.(\ref{Magnetization_001}). }
\label{Case1_fig} 
\end{figure}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
\sinh{(\eta/T)}=\frac{(2\pi)^2n_p}{2T^3}\,\frac{1}{\left[x^2K_2(x)+b_0xK_1(x)+\frac{b^2_0}{6}K_0(x)\right]}
  \end{align}
and
